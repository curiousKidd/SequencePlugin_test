...
public class MyPsiUtil {
    ...
    public static boolean isInProject(@Nullable PsiElement paramPsiElement) {
             if (paramPsiElement == null) return false;

             return PsiManager.getInstance(paramPsiElement.getProject()).isInProject(paramPsiElement);
        }

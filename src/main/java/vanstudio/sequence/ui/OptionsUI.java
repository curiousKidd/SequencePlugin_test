...
public class OptionsUI {
    ...
    public static class DialogPanel extends JPanel {
        ...
        private final JCheckBox jCheckBoxPCO;
...
//        private final JCheckBox jCheckBoxSI;
        ...
        public DialogPanel() {
            ...
            jCheckBoxPCO = new JCheckBox("Display only project classes", state.projectClassesOnly);
            add(jCheckBoxPCO, gc);
    ...
    public static class OptionsDialogWrapper extends DialogWrapper {
        ...
        public boolean isProjectClassesOnly() {
            return dialogPanel.jCheckBoxPCO.isSelected();
        }

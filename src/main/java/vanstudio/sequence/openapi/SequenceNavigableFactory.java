...
public class SequenceNavigableFactory {
    private static final ExtensionPointName<LanguageExtensionPoint<SequenceNavigable>> EP_NAME = ExtensionPointName.create("SequenceDiagramGW.sequenceNavigable");
